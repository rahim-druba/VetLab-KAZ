    ...
    <div className="min-h-screen bg-[#f0f7ff]">
      <section className="bg-secondary text-white py-12 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight">{t?.terms ?? 'Lab Terms'}</h1>
        </div>
      </section>
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl border border-slate-100 shadow-md p-8 md:p-10 space-y-6 text-slate-600 leading-relaxed">
          <p>{t?.termsIntro}</p>
          <h2 className="text-secondary font-bold text-lg mt-8">{t?.termsServices}</h2>
          <p>{t?.termsServicesDesc}</p>
          <h2 className="text-secondary font-bold text-lg mt-8">{t?.termsSamplesReporting}</h2>
          <p>{t?.termsSamplesReportingDesc}</p>
          <h2 className="text-secondary font-bold text-lg mt-8">{t?.termsLimitation}</h2>
          <p>{t?.termsLimitationDesc}</p>
          <p className="text-sm text-slate-500 mt-10">{t?.termsMockNote}</p>
        </div>
        <div className="mt-8">
